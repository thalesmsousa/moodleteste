...
$strheading = get_string('alertsprototype', 'local_lanalytics');
$PAGE->set_pagelayout('standard');
$PAGE->set_context(context_system::instance());
$PAGE->set_url(new moodle_url('/local/lanalytics/alerts_prototype.php'));
...
echo '<img src="pix/indicadores.jpg" width="800" />';
echo '</span>';
