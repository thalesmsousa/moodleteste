...
$strheading = get_string('interferenceprototype', 'local_lanalytics');
$PAGE->set_pagelayout('standard');
$PAGE->set_context(context_system::instance());
$PAGE->set_url(new moodle_url('/local/lanalytics/interference_prototype.php'));
...
echo '<img src="pix/interferencias.jpg" width="800" />';
echo '</span>';
