...
$strheading = get_string('reportsprototype', 'local_lanalytics');
$PAGE->set_pagelayout('standard');
$PAGE->set_context(context_system::instance());
$PAGE->set_url(new moodle_url('/local/lanalytics/reports_prototype.php'));
...
echo '<img src="pix/relatorios.jpg" width="800" />';
echo '</span>';
